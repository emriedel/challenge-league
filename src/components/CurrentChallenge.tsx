    ...
    return (
      <>
        <div className="">
          ...
          {/* Rules info - below submission form */}
          {showSubmission && (
            <div className="flex justify-center mb-6 text-center">
              <span className="text-app-text-secondary text-sm inline-flex items-center gap-1">
                You can change your submission until the deadline
                <button
                  onClick={() => setShowRulesModal(true)}
                  className="text-app-text-secondary hover:text-app-text transition-colors inline-flex items-center justify-center"
                  data-testid="open-rules-modal"
                  aria-label="View submission rules"
                >
