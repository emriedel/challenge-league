            ...
            {status === 'authenticated' ? (
              <>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <Link 
                    href="/profile"
                    className="flex items-center pl-2 pr-1 py-2 text-white/80 hover:text-white transition-colors"
                  >
          ...
          <div className="md:hidden flex items-center space-x-3">
            {status === 'authenticated' ? (
              <>
                ...
                {/* Profile/Settings Gear */}
                <Link href="/profile" className="flex items-center pl-2 pr-1 py-2 text-white/80 hover:text-white transition-colors">
